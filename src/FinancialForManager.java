...
public class FinancialForManager  extends JFrame implements ActionListener{
	...
	public FinancialForManager(ManagerHome managerInstance,Login loginInstance) {
	...
	public void actionPerformed(ActionEvent e) {
      ...
      if(e.getActionCommand().equals("Logout")) {
			...
			this.managerInstance.setVisible(true);
